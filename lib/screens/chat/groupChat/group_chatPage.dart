                    ...
                    IconButton(
                        onPressed: () {
                          chatController.groupNameController.value.text =
                              chatController.groupInfo.value.groupName
                                  .toString();
                          showDialog(
                            context: context,
                            builder: (context) =>
                                AlertDialog(
                                    content: AppWidget.textFormFiledProfilePage(
                                        ...
                                        chatController.groupNameController
                                            .value),
                                    actions: [
                                      Row(
                                        children: [
                                ...
                                onTap: () {
                                  if (chatController.groupInfo.value.isArchive
                                    ...
                                    chatController.groupChatRoomCollection
                                        .doc(
                                        chatController.groupInfo.value.groupId
                                            .toString())
                                        .update({
                                    ...
                                    chatController.groupChatRoomCollection
                                        ...
                                        chatController.groupInfo.value.groupId
                                            .toString())
                                        .update({
                                      ApiConstant.isArchive: FieldValue
                                          .arrayUnion([
                                        authController.userModel.value.user?.id
                                            .toString()
                                      ]),
